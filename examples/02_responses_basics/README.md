...
**Concepts**: Agent tool calling, calculator tool, ticker data tool, web search tool, function execution

**Description**: Shows how to use the Responses API with an agent that can call tools like calculator, stock ticker data retrieval, and web search to answer questions.
...
**Concepts**: Response streaming, real-time output, agent tool calls streaming, event handling, progressive rendering

**Description**: Shows how to stream agent responses and tool calls in real-time, allowing for progressive display of output as it's generated.
